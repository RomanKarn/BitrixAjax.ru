...
<div class="row">
    <? $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "BASKET_URL" => "/auth/basket/",    // URL, ведущий на страницу с корзиной покупателя
            ...
            "SEARCH_RESTART" => "Y",    // Искать без учета морфологии (при отсутствии результата поиска)
